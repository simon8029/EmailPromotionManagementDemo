...
namespace Simon8029.EMPDemo.Service{
    public partial class EM_CampaignInstancesService : BaseService<EM_CampaignInstances>,IEM_CampaignInstancesService
    {
    	public override void SetIBaseRepository()
    	{
    		IbaseRepository=DbSession.EM_CampaignInstancesRepository;
    	}
    }
}
