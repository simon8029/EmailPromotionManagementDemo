...
namespace Simon8029.EMPDemo.Service{
    public partial class employeeRoleRelationshipService : BaseService<employeeRoleRelationship>,IemployeeRoleRelationshipService
    {
    	public override void SetIBaseRepository()
    	{
    		IbaseRepository=DbSession.employeeRoleRelationshipRepository;
    	}
    }
}
