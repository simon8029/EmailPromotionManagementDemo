...
namespace Simon8029.EMPDemo.Service{
    public partial class EM_EmailTemplatesService : BaseService<EM_EmailTemplates>,IEM_EmailTemplatesService
    {
    	public override void SetIBaseRepository()
    	{
    		IbaseRepository=DbSession.EM_EmailTemplatesRepository;
    	}
    }
}
