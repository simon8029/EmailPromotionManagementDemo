...
namespace Simon8029.EMPDemo.Service{
    public partial class RolePermissionRelationshipService : BaseService<RolePermissionRelationship>,IRolePermissionRelationshipService
    {
    	public override void SetIBaseRepository()
    	{
    		IbaseRepository=DbSession.RolePermissionRelationshipRepository;
    	}
    }
}
