...
namespace Simon8029.EMPDemo.Service{
    public partial class EM_EmailInstancesService : BaseService<EM_EmailInstances>,IEM_EmailInstancesService
    {
    	public override void SetIBaseRepository()
    	{
    		IbaseRepository=DbSession.EM_EmailInstancesRepository;
    	}
    }
}
